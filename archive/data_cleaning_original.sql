-- Archived September 2023 exploratory query.
--
-- This file is retained for provenance. It is not the current reproducible
-- pipeline; use the numbered scripts under ../sql instead.
